...
await shoot('gitengine', P.gitengine, async (p) => { await p.waitForFunction(() => [...document.querySelectorAll('#term .out')].some(el => el.textContent.includes('survey complete')), null, { timeout: 75_000 }); await p.waitForTimeout(1200) })
